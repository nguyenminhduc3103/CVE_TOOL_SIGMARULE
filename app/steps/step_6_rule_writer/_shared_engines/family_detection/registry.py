...
from app.steps.step_6_rule_writer._shared_engines.family_detection.base import DetectionTemplate
from app.steps.step_6_rule_writer._shared_engines.family_detection.templates import (
