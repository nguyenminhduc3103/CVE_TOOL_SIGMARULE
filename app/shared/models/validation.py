...
Nằm trong app.shared.models để EnrichedCVEContext có thể import mà không
gây circular dependency với app.steps.step_2_tech_analysis.
"""
...
VerdicType = Literal["PASS", "PARTIAL", "FAIL", "UNKNOWN"]
