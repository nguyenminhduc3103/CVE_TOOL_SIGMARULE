...
from app.models.telemetry import SigmaLogsource, TelemetryAssessment, TelemetryRequirements
...
from app.telemetry.taxonomy_validator import validate_fields_by_logsources
