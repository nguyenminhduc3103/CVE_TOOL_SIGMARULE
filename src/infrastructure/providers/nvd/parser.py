...
from src.domain.constants import MAX_CPES_PREVIEW, MAX_REFERENCES_PREVIEW
...
class NVDParser:
    ...
    def normalize(self, raw: Any) -> CoreCVEData:
        ...
        if cpes:
            try:
                from src.shared.parsers.cpe_parser import parse_cpe_list
