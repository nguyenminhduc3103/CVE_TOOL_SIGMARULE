...
from src.usecases.step_6_generate_sigma.validators.quality_scorer import QualityScorer
from src.usecases.step_6_generate_sigma.validators.validation_models import ValidationResult
