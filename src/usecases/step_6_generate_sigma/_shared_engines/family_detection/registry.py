...
from src.usecases.step_6_generate_sigma._shared_engines.family_detection.base import DetectionTemplate
from src.usecases.step_6_generate_sigma._shared_engines.family_detection.templates import (
