...
from src.shared.parsers.cvss_parser import (
    is_local_only as _is_local_only,
    is_network_reachable as _is_network_reachable,
    is_pre_auth as _is_pre_auth,
)
from src.usecases.step_2_analysis.rule_based.cwe_mapper import (
    CWE_BEHAVIOR_MAP,
)
...
# Đường dẫn tới data files (nằm trong src/infrastructure/local_truth/)
_DATA_DIR = Path(__file__).resolve().parents[2] / "infrastructure" / "local_truth"
...
class OntologyManager:
    ...
    def resolve(self, ctx: CveContext) -> ExpectedTTPs:
        ...
        from src.usecases.step_2_analysis.rule_based.attack_mapper import (
